    ...
    switch (action) {
        case 'get-current-weather':
            if (parameters.fields.hasOwnProperty('geo-city') && parameters.fields['geo-city'].stringValue!='') {
                request({
                    url: 'https://api.openweathermap.org/data/2.5/weather', //URL to hit
                    qs: {
                    ...
                    if (response.statusCode === 200) {
                        ...
                        if(weather.hasOwnProperty('weather')) {
                            ...
                            sendTextMessage(sender,
                                `No weather forecast availabe for ${parameters.fields['geo-city'].stringValue}`);
                        }
                    } else {
        ...
        case "faq-delivery":
            ...
            setTimeout(function() {
                let buttons = [
                    {
                        type:"web_url",
                        url:"https://www.myapp.com/track_order",
